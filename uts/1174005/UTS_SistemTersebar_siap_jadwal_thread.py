# -*- coding: utf-8 -*-
"""
Created on Tue Apr 28 21:53:41 2020
...
# In[Membuat Thread Untuk Menghitung Jumlah Barang]:
...
def hitungBarang(n):
    ...
    if (n == 0):
        print("Jumlah Barang : %s , Barang Kurang \n" %n)
        
        
    elif (n > 1 and n < 5) :
        print("Jumlah Barang : %s , Cari Barang Lagi \n" %n)
        
        
    else :
        print("Jumlah Barang : %s , Barang Bagus \n" %n)


m1 = threading.Thread(target=hitungBarang,args=(0,))

m2 = threading.Thread(target=hitungBarang,args=(3,))

m3 = threading.Thread(target=hitungBarang,args=(7,))
...
def greet_them(people):
    ...
    for person in people:
        ...
        print("Hello  " + person + ". Apa kabar kamu?")
...
people = ['Mali', 'Bere', 'Oniwaldus', 'Sule', 'Ferdinand']
